...
Version  : 1.3.1
Release  : 9
URL      : https://cran.r-project.org/src/contrib/spatstat.data_1.3-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/spatstat.data_1.3-1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1528817709
