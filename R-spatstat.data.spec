...
Version  : 3.0.4
Release  : 60
URL      : https://cran.r-project.org/src/contrib/spatstat.data_3.0-4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/spatstat.data_3.0-4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705423164
