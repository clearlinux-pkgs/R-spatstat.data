...
Version  : 2.1.2
Release  : 42
URL      : https://cran.r-project.org/src/contrib/spatstat.data_2.1-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/spatstat.data_2.1-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639764274
